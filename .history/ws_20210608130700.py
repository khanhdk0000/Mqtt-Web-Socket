...
def mqttPost(topic, user, pass):
    import paho.mqtt.publish as publish

    publish.single('Drakies3172/feeds/{}'.format(feed_id),hostname="io.adafruit.com",auth={"username":, "password":ADAFRUIT_IO_KEY},payload = payload)
